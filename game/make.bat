...
ml /c /coff /Cp background.asm || goto :error

::edit the linker
link /SUBSYSTEM:WINDOWS  /LIBPATH:%MASMLIBPATH% game.obj blit.obj trig.obj lines.obj stars.obj bitmaps.obj background.obj libgame.obj
